...
if __name__ == "__main__":
    if os.environ.get("EAI_CAMPAIGN_CONTAINER") != "1":
        raise RuntimeError(
            "EAI Desktop disables direct host execution of AI Scientist v2. "
            "Launch it through the approved Campaign Docker runtime."
        )
